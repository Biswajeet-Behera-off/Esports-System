        ...
        <div class="row">
            ...
            <section class="col-md-4 mb-5">
                <div class="card shadow p-3" data-aos="zoom-in" data-aos-duration="1500">
                    <figure class="imghvr-zoom-out">
                        <img src="images/developers/developer2.jpg" class="img-fluid" alt="Vishal Bait">

                        <figcaption>
                            <div class="text-center my-3">
                                <h4 class="font-time mb-4">Biswajeet Behera</h4>
                ...
                <div class="text-center mt-5" data-aos="fade-up">
                    <h4 class="font-time mb-2 text-primary">Biswajeet Behera</h4>
            ...
            <section class="col-md-4 mb-5">
                <div class="card shadow p-3" data-aos="zoom-in" data-aos-duration="1500">
                    ...
                    <figure class="imghvr-zoom-out">
                        <img src="images/developers/developer1.jpeg" class="img-fluid" alt="Suraj Mohite">

                        <figcaption>
                            <div class="text-center my-3">
                                <h4 class="font-time mb-4">Priyanshu kumar</h4>
                ...
                <div class="text-center mt-5" data-aos="fade-up">
                    <h4 class="font-time mb-2 text-primary">Priyanshu kumar</h4>
            ...
            <section class="col-md-4 mb-5">
                <div class="card shadow p-3" data-aos="zoom-in" data-aos-duration="1500">
                    ...
                    <figure class="imghvr-zoom-out">
                        <img src="images/developers/developer3.jpeg" class="img-fluid" alt="Onkar Mokashi">
                        <figcaption>

                            <div class="text-center my-3" data-aos="fade-up">
                                <h4 class="font-time mb-4">Vasudev Jha</h4>
                                <h5>Front-End Developer and Database</h5>
                            </div>
                ...
                <div class="text-center mt-5" data-aos="fade-up">
                    <h4 class="font-time mb-2 text-primary">Vasudev Jha</h4>
                    <h5 class="font-time">Front-End Developer and Database</h5>
                </div>
